...
static PyObject* postprocess_bridge(PyObject* self, PyObject* args) {
    ...
    if(!PyArg_ParseTuple(args, "O!O!iiff",      // link_logits, segm_logits, input_w, input_h, link_conf, cls_conf
        &PyArray_Type, &link_logits, &PyArray_Type, &segm_logits,
    ...
    auto rects = postProcess(link_data_pointer, link_shape, link_conf_threshold,
                cls_data_pointer,  cls_shape,  cls_conf_threshold, input_w, input_h);
